...
Note: RDK7 & RDK6 are listed in reverse order–this is correct. Note: All 54 mm spacers are white. Note: The RDK 15 uses a slower burning composition than other 38mm delays, and the delay grain has a black stripe on the outside.
